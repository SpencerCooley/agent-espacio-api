...
class FolderItemResponse(BaseModel):
    ...
    is_public: bool = Field(..., description="Whether this item is directly marked as public")
    inherited_public: Optional[bool] = Field(None, description="True if this item is public via inherited folder permissions")
    public_magic_id: Optional[UUID] = Field(None, description="Public share magic link ID")
    created_at: datetime = Field(..., description="Creation timestamp")
    updated_at: datetime = Field(..., description="Last update timestamp")
