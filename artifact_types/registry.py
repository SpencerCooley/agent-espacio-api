...
ARTIFACT_TYPES: dict[str, dict[str, Any]] = {
    ...
    "repo": {
        ...
        "ai_instructions": (
            ...
            "  2. The system initializes a bare git repository on disk and returns an SSH URL\n"
            "  3. Use git normally (clone, push, pull) via the SSH URL:\n"
            "     git clone ssh://git@<GIT_HOST>:2222/repos/<artifact_id>.git\n"
            "     git remote add origin ssh://git@<GIT_HOST>:2222/repos/<artifact_id>.git\n"
            "     git push -u origin master\n\n"
            "SSH ASSUMPTION:\n"
            "  The agent assumes the local machine already has SSH keys configured by the\n"
            "  human user. The agent does NOT generate SSH keys, modify ~/.ssh/, or call\n"
